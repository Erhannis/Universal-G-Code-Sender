...
public class ProbeServiceTest {
    ...
    public void testProbeServiceZ() throws Exception {
        ...
        ProbeParameters pc = new ProbeParameters(1, new Position(5, 5, 5, Units.MM), 10, 10, 10., 1, 1, 1,  2, 2, 2, 100, 25, 5, Units.INCH, G54);
        testZProbe(pc);

        pc = new ProbeParameters(1, new Position(5, 5, 5, Units.MM), 10, 10, -10., 1, 1, 1, 2, 2, 2, 100, 25, 5, Units.INCH, G54);
        testZProbe(pc);
    }
    ...
    public void testProbeServiceOutside() throws Exception {
        ...
        ProbeParameters pc = new ProbeParameters(1, new Position(5, 5, 5, Units.MM), 10, 10, 0., 1, 1, 1, 2, 2, 2, 100, 25, 5, Units.MM, G55);
